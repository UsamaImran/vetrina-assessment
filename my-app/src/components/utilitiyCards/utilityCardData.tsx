...
export const utilityCardsData: ICard[] = [
        ...
        body: (
            <Box>
                ...
                <Box sx={utilitySection}>
                    <Typography>
                        Complete all the steps to have a complete shop to
                        best present to your customers.
                    </Typography>
                </Box>
            </Box>
        ),
    ...
    },
    {
        header: (
            <Box sx={headerRow}>
                ...
                <Typography
                    variant="h6"
                    sx={{ paddingTop: 0.5, marginLeft: 1 }}
                >
                    Trustpilot
                </Typography>
            </Box>
    ...
    },
    {
        ...
        body: (
            <Box>
                <Typography>
                    <b style={{ color: PRIMARY_GREEN }}>
                        Receive 50 products
                    </b>
                    &nbsp; by inviting a friend who subscribes to a plan.
                    Your friend will receive a 30% discount coupon valid for
                    any plan.
                </Typography>
            </Box>
        ),
